...
const Home = function () {
	return (
		<>
			...
			<p>
				Real progress comes from within. Getting through the stress, the fog, or the noise is always
				the barrier to finding your own solution, and that’s what we do, help you get through all
				the noise, think clearly and work out how to execute.
			</p>
			<p>WE do this by;</p>
			<ul>
